...
import { ArrowRight, ChevronRight, Menu, X, Footprints } from 'lucide-react'
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">Discover Our Powerful Tools for Organizers</span>
                                    ...
                                    <h1
                                        ...
                                        Modern Solutions for Event Organizers
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                                        Highly customizable components for building modern outdoor events and communities that look and feel the way you mean it.
                                    </p>
                                </AnimatedGroup>
