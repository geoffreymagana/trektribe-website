    ...
    return (
      <button
        className={cn(
          ...
          "rounded-md", // Added for consistency
...
const PromptInputTextarea: React.FC<PromptInputTextareaProps> = ({
  ...
  React.useEffect(() => {
    ...
    const newHeight = typeof maxHeight === "number"
...
export const PromptInputBox = React.forwardRef((props: {}, ref: React.Ref<HTMLDivElement>) => {
  ...
  const searchSuggestions = [
    "Find a beginner-friendly hike this weekend near Nairobi",
    "Are there any events that support climate action in Kenya?",
  ];
  ...
  React.useEffect(() => {
    if (!document.getElementById('ai-prompt-styles')) {
  ...
  React.useEffect(() => {
    ...
    if (!isPending && (state.events || (state.message && !state.fieldErrors))) {
      setInput("");
      setFiles([]);
      setFilePreviews({});
    }
  ...
  React.useEffect(() => {
    ...
    if (promptElement) {
        promptElement.addEventListener("paste", handlePaste as EventListener);
        return () => promptElement.removeEventListener("paste", handlePaste as EventListener);
    }
  }, [handlePaste, ref]);
  ...
  const handleStopRecording = (duration: number) => {
    ...
    const formData = new FormData();
    formData.append("query", `[Voice message - ${duration} seconds]`);
    startTransition(() => {
        formAction(formData);
    });
  };
      ...
      <div className="w-full max-w-4xl mx-auto flex flex-col items-center">
        ...
        <form action={formAction} ref={formRef} className="w-full">
            ...
            >
                ...
                >
                <PromptInputTextarea
                    placeholder="Find a Saturday hike with snacks..."
                    className="text-base"
                />
                </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <Globe className="w-4 h-4 text-[#1EAEDB]" />
                        </motion.div>
                        </div>
                        <AnimatePresence>
                            <motion.span
                ...
                >
                    ...
                    className={cn(
                        ...
                        : "bg-transparent hover:bg-gray-600/30 text-[#9CA3AF] hover:text-[#9CA3AF]"
                    )}
                    ...
                    onClick={(e) => {
                        ...
                        // For hasContent, let the form submit
                    }}
                    disabled={isPending && !hasContent}
                    >
                    {isPending ? (
                        <Square className="h-4 w-4 fill-current text-[#1F2023] animate-pulse" />
                    ) : isRecording ? (
...
export function AIDemoBox() {
    return <PromptInputBox />;
}
